...
*/
/* this is dependent on compiler behavior*/
#include "data_type.h"

void DIO_vsetPINDir( uint8_ portname,uint8_ pinnumber,uint8_ direction);
...
*/
void DIO_write(uint8_ portname,uint8_ pinnumber,uint8_ outputvalue);
...
*/
unsigned char DIO_u8read(uint8_ portname,uint8_ pinnumber);
...
void DIO_vconnectpullup(int8_t portname ,uint8_ pinnumber, uint8_ connect_pullup);
/*
